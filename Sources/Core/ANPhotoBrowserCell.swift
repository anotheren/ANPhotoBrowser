...
public protocol ANPhotoBrowserCellDelegate: NSObjectProtocol {
    /// 拖动时回调。scale:缩放比率
    func photoBrowserCell(_ cell: ANPhotoBrowserCell, didPanScale scale: CGFloat)

    /// 单击时回调
    func photoBrowserCell(_ cell: ANPhotoBrowserCell, didSingleTap image: UIImage?)

    /// 长按时回调
    func photoBrowserCell(_ cell: ANPhotoBrowserCell, didLongPressWith image: UIImage, gesture: UILongPressGestureRecognizer)
...
open class ANPhotoBrowserCell: UICollectionViewCell {
    ...
    /// 代理
    open weak var cellDelegate: ANPhotoBrowserCellDelegate?
...
extension ANPhotoBrowserCell: UIScrollViewDelegate {
...
extension ANPhotoBrowserCell: UIGestureRecognizerDelegate {
